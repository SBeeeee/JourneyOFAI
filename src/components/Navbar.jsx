...
const Navbar = () => {
  ...
  return (
    <div style={{ fontFamily: '"Press Start 2P", cursive' }} className= "fixed top-0 h-12 w-full bg-gradient-to-b from-[#151515] to-[#1e1e1e] shadow-2xl z-12 flex justify-around nav">
