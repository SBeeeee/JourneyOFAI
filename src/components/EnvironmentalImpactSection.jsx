  ...
  return (
    ...
    <div className="max-w-5xl mx-auto space-y-14 text-neutral-200">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-3xl md:text-4xl font-bold text-white heading font-[Orbitron]">🌍 The Hidden Cost of AI</h2>
        <p className="text-lg text-neutral-400 res font-[Poppins]">Why responsible AI usage matters</p>
      </div>
  
      {/* Water Consumption */}
      <div className="one">
        <h3 className="text-2xl font-semibold mb-2 text-white font-[Orbitron]">💧 Water Consumption</h3>
        <p className="text-neutral-300 leading-relaxed font-[Poppins]">
      ...
      <div className="fade-in two">
        <h3 className="text-2xl font-semibold mb-2 text-white font-[Orbitron]">⚡ Energy Usage</h3>
        <p className="text-neutral-300 leading-relaxed font-[Poppins]">
      ...
      <div className="fade-in three">
        <h3 className="text-2xl font-semibold mb-2 text-white font-[Orbitron]">🧠 Limitations of AI</h3>
        <p className="text-neutral-300 leading-relaxed font-[Poppins]">
      ...
      <div className="fade-in four">
        <h3 className="text-2xl font-semibold mb-2 text-white font-[Orbitron]">🎨 Ghibli-Inspired Reflections</h3>
        <p className="text-neutral-300 leading-relaxed font-[Poppins]">
